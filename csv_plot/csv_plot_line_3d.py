...
# -*- coding: utf-8 -*-
# ----------------------------------------------------------------------
# Name:         csv_plot_line_3d.py
# Description:
#
# Author:       m.akei
# Copyright:    (c) 2020 by m.na.akei
# Time-stamp:   <2020-10-09 10:26:02>
# Licence:
...
def init():
    arg_parser = argparse.ArgumentParser(description="plot 3d line chart",
...
if __name__ == "__main__":
    ...
    if output_file is None:
        if csv_file != "-":
            output_file = Path(csv_file).stem + "_line_3d." + output_format
        else:
...
""".format(csv_file, output_file), file=sys.stderr)
    ...
    # plotly.express.line_3d  4.11.0 documentation https://plotly.com/python-api-reference/generated/plotly.express.line_3d.html#plotly.express.line_3d
    fig = px.line_3d(csv_df, **fig_params)
