...
# -*- coding: utf-8 -*-
# ----------------------------------------------------------------------
# Name:         csv_plot_strip.py
# Description:
#
# Author:       m.akei
# Copyright:    (c) 2020 by m.na.akei
# Time-stamp:   <2020-09-06 09:15:24>
# Licence:
...
def init():
    arg_parser = argparse.ArgumentParser(description="plot strip chart",
...
if __name__ == "__main__":
    ...
    if output_file is None:
        if csv_file != "-":
            output_file = Path(csv_file).stem + "_strip_{}.".format(strip_mode) + output_format
        else:
    ...
    fig_params["stripmode"] = strip_mode
